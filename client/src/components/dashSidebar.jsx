  ...
  return (
    <aside class="lg:flex lg:flex-col lg:w-64 w-screen lg:h-screen px-4 py-8 overflow-y-auto border-b-2 lg:border-r lg:rtl:border-r-0 lg:rtl:border-l dark:border-[rgb(35,39,42)] dark:bg-[rgb(35,39,42)]">
            ...
            <div class=" hidden lg:flex flex-col items-center mt-6 -mx-2">
                <img class="object-cover w-24 h-24 mx-2 rounded-full" src={currentUser.photoUrl} alt="avatar" />
            ...
            <div class="flex flex-col justify-between flex-1 mt-6">
                <nav>
                    ...
                    <button onClick={() => handleButtonClick('signout')} class={`flex lg:w-[220px] w-full items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-600/20 dark:hover:text-gray-200 hover:text-gray-700 ${activeButton === 'signout' && 'dark:bg-gray-600/20 dark:text-white bg-gray-100'}`}>
                        <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
