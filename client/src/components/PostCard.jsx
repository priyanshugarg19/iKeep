...
function PostCard({post}) {
  return (
    <div className='group w-full relative overflow-hidden border sm:w-[430px] h-[366px] dark:border-gray-600 hover:border-2 rounded-md transition-all mx-2'>
